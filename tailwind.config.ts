  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        wealth: {
          positive: "hsl(var(--wealth-positive))",
          negative: "hsl(var(--wealth-negative))",
          neutral: "hsl(var(--wealth-neutral))",
        },
        asset: {
          land: "hsl(var(--asset-land))",
          ...
          realEstate: "hsl(var(--asset-real-estate))",
